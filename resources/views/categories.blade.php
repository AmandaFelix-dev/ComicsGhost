    ...
    <div class="container my-5">
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p class="lead">
                    Aqui você encontra HQs organizadas por gêneros, desde super-heróis até aventuras intensas. Escolha seu
                    favorito e mergulhe em um universo de emoções!
                </p>
                <div class="dropdown mt-3">
                    <button class="btn btn-dark dropdown-toggle" type="button" id="dropdownGeneros" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Listar gêneros
                    </button>
            ...
            <div class="col-md-6 text-center">
                {{-- Imagem do Banner --}}
                <img src="{{ asset('assets/image/jovenstitasbanner.png') }}" alt="Banner Jovens Titãs"
        ...
        <section id="acao" class="genero-section text-center my-5">
            <div class="container">
                ...
                <div id="carouselAcao" class="carousel slide" data-bs-ride="carousel">
                        ...
                        @if (isset($acao) && count($acao) > 0)
                            @foreach ($acao as $index => $hq)
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                    <div class="card d-flex flex-row align-items-center p-3 mx-auto"
                                        style="max-width: 700px;">
                                        <img src="{{ asset('assets/image/home/hqs/' . $hq->imagens) }}"
                                            alt="{{ $hq->titulo }}" class="img-fluid me-3 rounded"
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselAcao"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselAcao"
                        data-bs-slide="next">
        ...
        <section id="drama" class="genero-section text-center my-5">
            <div class="container">
                ...
                <div id="carouselDrama" class="carousel slide" data-bs-ride="carousel">
                            ...
                            @foreach ($drama as $index => $hq)
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                    <div class="card d-flex flex-row align-items-center p-3 mx-auto"
                                        style="max-width: 700px;">
                                        <img src="{{ asset('assets/image/home/hqs/' . $hq->imagens) }}"
                                            alt="{{ $hq->titulo }}" class="img-fluid me-3 rounded-3 shadow-sm"
                                            style="width: 120px; height: 160px; object-fit: cover;">
                                        <div class="card-body">
                                            <h5 class="card-title fw-bold">{{ $hq->titulo }}</h5>
                                            <p class="card-text">{{ Str::limit($hq->descricao, 60) }}</p>
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselDrama"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Anterior</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselDrama"
                        data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Próximo</span>
                    </button>
                                ...
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                    <div class="card d-flex flex-row align-items-center p-3 mx-auto"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('hqs.show', $hq->id) }}" class="btn btn-danger">Veja
                                                mais</a>
                                        </div>
                                    </div>
                                </div>
