...
<!-- Ação -->
  ...
  <!-- Item 1 -->
    ...
    <div class="carousel-item">
      <div class="card d-flex flex-row align-items-center p-3 mx-auto" style="max-width: 700px;">
      <img src="{{ asset('assets/image/home/hqs/hq4.png') }}" alt="HQ3" class="img-fluid me-3 rounded" style="width: 120px;">
        <div class="card-body">
   ...
   <div class="carousel-item">
      <div class="card d-flex flex-row align-items-center p-3 mx-auto" style="max-width: 700px;">
      <img src="{{ asset('assets/image/home/hqs/hq6.png') }}" alt="HQ3" class="img-fluid me-3 rounded" style="width: 120px;">
        <div class="card-body">
  ...
  <div class="container">
    ...
    <div id="carouselSuspense" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <div class="card d-flex flex-row align-items-center p-3 mx-auto" style="max-width: 700px;">
          <img src="{{ asset('assets/image/home/hqs/hq2.png') }}" alt="HQ3" class="img-fluid me-3 rounded" style="width: 120px;">
            <div class="card-body">
        ...
        <div class="carousel-item">
          <div class="card d-flex flex-row align-items-center p-3 mx-auto" style="max-width: 700px;">
          <img src="{{ asset('assets/image/home/hqs/hq5.png') }}" alt="HQ3" class="img-fluid me-3 rounded" style="width: 120px;">
            <div class="card-body">
  ...
  <div class="container">
    ...
    <div id="carouselDrama" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <div class="card d-flex flex-row align-items-center p-3 mx-auto" style="max-width: 700px;">
          <img src="{{ asset('assets/image/home/hqs/hq7.png') }}" alt="HQ3" class="img-fluid me-3 rounded" style="width: 120px;">
            <div class="card-body">
